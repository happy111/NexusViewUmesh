...
[![PyPI version](https://img.shields.io/pypi/v/NexusViewUmesh.svg)](https://pypi.org/project/NexusViewUmesh/)
[![Python versions](https://img.shields.io/pypi/pyversions/NexusViewUmesh.svg)](https://pypi.org/project/NexusViewUmesh/)
[![License](https://img.shields.io/pypi/l/NexusViewUmesh.svg)](https://github.com/entbappy/NexusViewPro/blob/main/LICENSE)
...
```bash
pip install NexusViewUmesh
```

```python
from NexusViewUmesh.youtube import render_youtube_video

render_youtube_video("https://www.youtube.com/watch?v=h25pePMdoPA&t=712s")
```

```python
from NexusViewUmesh.site import render_site
